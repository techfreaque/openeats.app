...
INSERT INTO "new_partners" ("city", "countryId", "createdAt", "delivery", "description", "email", "id", "image", "latitude", "longitude", "mainCategoryId", "name", "phone", "published", "rating", "street", "streetNumber", "updatedAt", "zip") SELECT "city", "countryId", "createdAt", "delivery", "description", "email", "id", "image", "latitude", "longitude", "mainCategoryId", "name", "phone", "published", "rating", "street", "streetNumber", "updatedAt", "zip" FROM "partners";
DROP TABLE "partners";
