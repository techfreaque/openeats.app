...
export const commitChanges: Version[] = [
  {
    ...
    changes: [
      ...
      {
        type: "feature",
        description: "Mode (balanced, creative) selection in settings",
      },
  ...
  },
  {
    ...
    changes: [
      {
        type: "feature",
        description: "Implemented full screen functionality (ctrl/cmd + k)",
      },
  ...
  },
  {
    ...
    changes: [
      {
        type: "feature",
        description: "Added new models - Mistral, Codestral, GitHub models",
      },
      {
        type: "improvement",
        description:
          "Refactored supportedllm.ts to remove Codestral from supported models",
      },
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "bugfix",
        description: "Resolved localStorage not defined error",
      },
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "feature",
        description: "Implemented custom theme functionality",
      },
      {
        type: "improvement",
        description: "Refactored links in settings and about pages",
      },
      {
        type: "improvement",
        description: "Refactored settings page and about page",
      },
      ...
      {
        type: "bugfix",
        description: "Fixed apostrophe rendering in themes page",
      },
      {
        type: "bugfix",
        description: "Fixed apostrophe rendering in general page",
      },
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        description: "Implemented Anthropic provider registry",
      },
    ],
  },
  {
    ...
    changes: [
      ...
      {
        type: "improvement",
        description: "Refactored CSS class names to use lowercase letters",
      },
    ],
  },
  {
    ...
    changes: [
      ...
      {
        type: "bugfix",
        description: "Improved error handling when creating UI",
      },
      {
        type: "bugfix",
        description:
          "Fixed view-increment API route and generative suggestions",
      },
      {
        type: "other",
        description: "Increased number of UIs fetched in getUIHome to 11",
      },
      {
        type: "other",
        description: "Updated layout.tsx with favicon and script imports",
      },
      {
        type: "other",
    ...
    changes: [
      {
        type: "bugfix",
        description:
          "Fixed regenerate authorization, responsive lock, and UI image issues",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    changes: [
      ...
      {
        type: "feature",
        description: "Migrated authentication from Clerk to AuthJS",
      },
      {
        type: "feature",
        description: "Added time range filter to explore page",
      },
      { type: "feature", description: "Implemented forkedFrom label" },
      {
        type: "bugfix",
        description: "Fixed fork v2 reusable code documentation",
      },
      { type: "other", description: "Updated favicon link in layout.tsx" },
      {
        type: "other",
        description: "Updated ImageResponse import in icon.tsx",
      },
      {
        type: "other",
        description: "Updated branding to WindAI in UI components",
      },
      { type: "other", description: "Fixed layout overflow" },
      {
        type: "other",
        description: "Removed @babel/standalone dependency from package.json",
      },
    ],
  },
  {
    ...
    changes: [
      {
        type: "feature",
        description:
          "Added tooltip to display prompt details in UIHeader and UIRightHeader components",
      },
      {
        type: "feature",
        description: "Implemented controlled resize functionality",
      },
      {
        type: "feature",
        description: "Added ability to regenerate modified code",
      },
      {
        type: "feature",
        description: "Implemented UI ID sharing functionality",
      },
      {
        type: "improvement",
        description: "Refactored error handling in UI component",
      },
      {
        type: "bugfix",
        description:
          "Fixed code to use shared constants for maxDuration and dynamic values",
      },
      ...
      { type: "other", description: "Changed CodeViewer component" },
      {
        type: "other",
        description:
          "Changed maxDuration to 60, implemented global Anthropic reference",
      },
    ],
  },
];
