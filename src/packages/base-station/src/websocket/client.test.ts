...
describe("WebSocket Client", () => {
  ...
  describe("connect", () => {
    it("should connect to the WebSocket server", async () => {
      ...
      expect(WebSocketConstructorMock).toHaveBeenCalledWith("ws://localhost:8080");
    ...
    it("should handle connection errors", async () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith(expect.stringContaining("WebSocket error"), expect.any(Error));
    });
