...
import { config, getApiKey, loadConfig, resetApiKey, saveConfig, updateApiKey, updateConfig } from "./index";
...
vi.mock('fs', () => ({
  ...
  readFileSync: vi.fn().mockReturnValue(JSON.stringify({
    ...
    security: { apiKey: "test-api-key", defaultApiKey: "default-test-api-key" },
