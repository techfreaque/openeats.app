    ...
    return (
      <div className="container px-4 md:px-6 py-12">
        <div className="flex flex-col items-center text-center">
          <h1 className="text-3xl font-bold mb-4">{t("restaurant.notFound")}</h1>
                ...
                {user && (
                  ...
                  >
                    ...
                    <span className="sr-only">
                      {favorite ? t("restaurant.removeFromFavorites") : t("restaurant.addToFavorites")}
                    </span>
                  </Button>
                )}
              </div>
              ...
              <div className="rounded-lg border bg-muted p-4">
                ...
                <div className="mt-2 grid gap-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span>
                      {formatTime(openingHours[1]?.open || 660)} - {formatTime(openingHours[1]?.close || 1320)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>{t("restaurant.weekends")}</span>
                    <span>
                      {formatTime(openingHours[6]?.open || 600)} - {formatTime(openingHours[6]?.close || 1380)}
                    </span>
                  </div>
                </div>
              </div>
