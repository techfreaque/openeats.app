...
export const getGenerationPrompt = (
  ...
  return `
            ...
            ${useTypeScript ? "use typescript for the code. Do not define custom interface or types. just use predefined types like string, number etc " : "use javascript for the complete code"}
...
export const getCreativePrompt = (prompt: string): string => {
  return `
...
export const getBalancedPrompt = (prompt: string): string => {
  return `
...
export const getElementProperty = (): string => {
  return `
        ...
        Also include body tag. Assign maximum occurring color as background color of body.
...
export const getOptimizerPrompt = (): string => {
  return `
        Instructions:
