  ...
  try {
    ...
    await generateText({
      ...
      tools: {
        appIdea: tool({
          description:
            "Generate an array of 5 app ideas for a web or mobile application or specific functionality within an app",
          parameters: z.object({
    ...
    errorLogger("Error in suggestions API route:", error);
