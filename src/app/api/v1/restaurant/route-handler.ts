import type {
  ...
  SafeReturnType,
} from "@/packages/next-vibe/server/endpoints/core/api-handler";
import { hasRole } from "next-vibeibe/server/endpoints/data";
...
import type { UserRoleResponseType } from "next-vibeibe/shared/types/user-roles.schema";
