...
import type { MenuItemCreateType, MenuItemResponseType, MenuItemSearchType, MenuItemUpdateType } from "../restaurant/schema/menu.schema";
 ...
 */
export function useMenuItems(params?: { restaurantId?: string; categoryId?: string }) {
  return useApiQuery(
    menuItemsEndpoints.GET,
    params || {},
    undefined,
    {
      enabled: true,
 ...
 */
export function useUpdateMenuItem(menuItemId?: string, initialData?: Partial<MenuItemUpdateType>) {
