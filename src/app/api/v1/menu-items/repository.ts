...
import type { MenuItemCreateType, MenuItemResponseType, MenuItemUpdateType } from "../restaurant/schema/menu.schema";
...
export async function getMenuItems(
  ...
  try {
    ...
    if (params.restaurantId) {
      filteredItems = filteredItems.filter(item => item.restaurantId === params.restaurantId);
    }
